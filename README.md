...
- Phase 2 kickoff viewer foundations with:
  ...
  - CLI helper (`python -m pdf_signer phase2-evidence ...`) to generate Phase 2 markdown timing evidence snippets, including optional auto-capture of idle memory + bundle-size metrics for FR-16 evidence
