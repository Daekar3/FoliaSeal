...
- Key collaborators: `SigningDraftWorkflow`, `CertificateCatalogRepository`, `CertificateSigningMaterialPort`, `SignaturePresetCatalogStore`, `signing_shell.py`.
