...
- Key collaborators: `SigningDraftWorkflow`, `CertificateCatalogRepository`, `CertificateSigningMaterialPort`, `ReusableSigningObjects`, `signing_shell.py`.
