...
- Owns: `Phase3HarnessCapture`, `Phase3InteractiveHarnessRunner`, `Phase3InteractiveCaptureArtifactPolicy`, `build_interactive_phase3_capture_runner()`, and `jsonable_capture()`.
...
- Main entry points: `Phase3InteractiveHarnessRunner.run()` and `build_interactive_phase3_capture_runner()`.
