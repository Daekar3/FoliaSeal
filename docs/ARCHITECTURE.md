...
- Main entry points: `Phase3HarnessScenarioCommand.from_mapping()`, `QtPhase3HarnessWorkspaceAdapter.apply_scenario()`, `QtPhase3HarnessWorkspaceAdapter.current_request()`, `QtPhase3HarnessWorkspaceAdapter.last_signing_result()`, `QtPhase3HarnessWorkspaceAdapter.capture_snapshot()`, `QtPhase3HarnessWorkspaceAdapter.capture_state()`, `HeadlessPhase3HarnessWorkspaceAdapter.apply_scenario()`, `HeadlessPhase3HarnessWorkspaceAdapter.current_request()`, `HeadlessPhase3HarnessWorkspaceAdapter.capture_snapshot()`, `HeadlessPhase3HarnessWorkspaceAdapter.capture_state()`, and `phase3_harness.py::_apply_preview_matrix_scenario()`.
