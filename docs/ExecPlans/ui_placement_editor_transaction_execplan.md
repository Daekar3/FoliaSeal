...
After this slice, a user can transactional fixed-page Placement editing without storing PDF identity in the real FoliaSeal GUI. It is mapped to UI_SPEC SUR05, section 10, and normative placement SVG. The
...
- [ ] docs/ExecPlans/ui_signature_library_topology_execplan.md and docs/ExecPlans/ui_signature_preset_transactions_execplan.md
...
Begin by comparing the live PlacementProfile fields with SCHEMAS.md placement page_number/source_page
and document the conflict in this plan; do not silently change a frozen governing document. Then
provide a fixed-page Placement editor from a current PDF or blank page with direct
...
Before checking this child in the parent, record the governing UI_SPEC requirement and placement SVG,
