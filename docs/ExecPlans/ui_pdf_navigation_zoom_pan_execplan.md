...
After this slice, a user can single-page navigation, Fit Page/Fit Width, exact zoom, and pan behavior in the real FoliaSeal GUI. It is mapped to UI_SPEC section 8 and WF01. The
