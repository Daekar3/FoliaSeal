...
This document must be maintained in accordance with `docs/PLANS.md`. It is plan 2 of 5 for GitHub issue #50, "RFC: Deepen visible signature draft semantics boundary." It depends on `docs/ExecPlans/visible_signature_semantics_foundation_execplan.md`.
