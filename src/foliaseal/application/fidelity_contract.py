"""Versioned release-fidelity manifest contract for Acceptance evidence."""
...
RELEASE_FIDELITY_CONTRACT_VERSION = "fidelity_v1"
...
def validate_release_fidelity_contract(payload: Mapping[str, Any]) -> None:
    ...
    if tuple(counters or ()) != RELEASE_FIDELITY_CRITICAL_ZERO_COUNTERS:
        raise ValueError(
            "Release fidelity critical_zero_counters must match the Acceptance evidence contract."
        )
