"""Appearance snapshot shaping helpers for Phase 3 QA parity checks."""
...
class Phase3AppearanceSnapshotter:
    """Own both sides of the Phase 3 appearance parity model."""
