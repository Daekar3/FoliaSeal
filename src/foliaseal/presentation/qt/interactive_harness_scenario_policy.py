"""Qt-free scenario policy for the Acceptance harness workspace adapters."""
...
class InteractiveHarnessResolvedScenario:
...
class InteractiveHarnessScenarioResolver:
    ...
    def resolve(
        ...
        *,
        ...
        return InteractiveHarnessResolvedScenario(
