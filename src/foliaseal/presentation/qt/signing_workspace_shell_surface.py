"""Shell-owned public surface helper for the signing workspace."""
...
class SigningWorkspaceShellSurface:
    """Own the concrete widget export block and caller-facing shell verbs."""
    ...
    def install_widget_exports(self) -> None:
        ...
        self._widget.app_settings = self._get_app_settings()  # type: ignore[attr-defined]
