"""Per-scenario signed-acceptance execution boundary for Acceptance QA."""
...
BuildHarnessWorkspace = Callable[..., AcceptanceHarnessWorkspacePort]
...
class SignedAcceptanceScenarioResult:
    ...
    @classmethod
    def from_mapping(cls, payload: dict[str, Any]) -> SignedAcceptanceScenarioResult:
        return cls(
...
@dataclass(frozen=True)
class SignedAcceptanceScenarioExecutorDeps:
...
@dataclass(frozen=True)
class SignedAcceptanceScenarioExecutor:
    ...
    def run_result(
        ...
        *,
        ...
        if request is None:
            return SignedAcceptanceScenarioResult.from_mapping(result)
