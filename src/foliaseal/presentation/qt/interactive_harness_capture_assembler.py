"""Capture-assembly helpers for Acceptance harness evidence."""
...
class InteractiveHarnessCaptureAssembler:
    ...
    def _signed_output_snapshotter(self) -> AcceptanceSignedOutputSnapshotter:
