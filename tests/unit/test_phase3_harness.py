...
def test_run_phase3_harness_session_returns_raw_session_state(
    ...
    class _FakeShell:
        ...
        def submit_sign_request(self):
            ...
            self.last_signing_result = phase3_harness_module.SigningResult(
                success=True,
                failure_code=None,
                message="Signed",
            )
    ...
    monkeypatch.setattr(
        ...
        fake_build_qt_signing_shell,
    )
    monkeypatch.setattr(
        phase3_harness_module,
        "_snapshot_current_draft_request",
        lambda _workflow: request,
    )
    monkeypatch.setattr(
        phase3_harness_module,
        "_capture_interactive_state",
    ...
    viewer_workflow = phase3_harness_module.ViewerWorkflow(
        document_path=str(input_pdf),
        render_backend=object(),
        session=phase3_harness_module.ViewerSession(page_count=1),
    )
    ...
    result = phase3_harness_module._run_phase3_harness_session(
        bindings=bindings,
