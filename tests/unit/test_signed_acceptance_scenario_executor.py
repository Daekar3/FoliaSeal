...
class _FakeWorkspace:
    def __init__(self, *, request=None, capture=None) -> None:
        ...
        self.capture_snapshot_commands: list[InteractiveHarnessCaptureCommand] = []
...
def _executor(**overrides) -> SignedAcceptanceScenarioExecutor:
    ...
    return SignedAcceptanceScenarioExecutor(deps=deps)
...
def test_signed_acceptance_scenario_executor_exposes_typed_result_without_changing_mapping(
    ...
    assert isinstance(result, SignedAcceptanceScenarioResult)
