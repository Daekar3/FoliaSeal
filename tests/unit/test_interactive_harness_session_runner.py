...
import foliaseal.presentation.qt.interactive_harness_session_runner as runner_module
...
def test_session_runner_returns_raw_session_state(
    ...
    class _FakeWorkspace:
        ...
        def capture_snapshot(self, command: InteractiveHarnessCaptureCommand):
    ...
    runner = runner_module.InteractiveHarnessSessionRunner(
