...
from foliaseal.presentation.qt.interactive_harness_scenario_policy import (
    InteractiveHarnessResolvedScenario,
...
def _resolver() -> InteractiveHarnessScenarioResolver:
    return InteractiveHarnessScenarioResolver(
        profile_store=_ProfileStore(build_signature_appearance())
    )
...
def test_resolver_applies_common_preview_controls_and_preserves_effects() -> None:
    ...
    assert isinstance(resolved, InteractiveHarnessResolvedScenario)
...
def test_resolver_uses_named_profile_as_base() -> None:
    ...
    resolved = InteractiveHarnessScenarioResolver(
...
def test_policy_module_import_is_free_of_optional_runtime_dependencies() -> None:
    code = (
        "import sys; "
        "import foliaseal.presentation.qt.interactive_harness_scenario_policy; "
