...
def test_interactive_harness_capture_assembler_build_signed_run_bundle_freezes_sign_time_state(
    tmp_path: Path,
) -> None:
...
def test_interactive_harness_capture_assembler_build_capture_payload_uses_latest_signed_run() -> (
    None
):
