    ...
    *,
    ...
    return SignedAcceptanceMatrixRunner(
        deps=SignedAcceptanceMatrixRunnerDeps(
            ...
            build_signing_executor=build_signing_executor
...
def test_signed_acceptance_matrix_runner_closes_lifecycle_after_scenario_failure(
    ...
    source_pdf = tmp_path / "fixture.pdf"
    source_pdf.write_bytes(b"%PDF-1.4\n% fixture\n")
    lifecycle = FakeSignedAcceptanceLifecycle()
...
def test_signed_acceptance_matrix_runner_normalizes_typed_scenario_result(
    ...
    source_pdf = tmp_path / "fixture.pdf"
    source_pdf.write_bytes(b"%PDF-1.4\n% fixture\n")
    typed_result = SignedAcceptanceScenarioResult.from_mapping(
        {
            "name": "Scenario A",
            "profile_name": None,
